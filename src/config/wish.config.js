export default [
  { title: '一起去徐霞客故居', done: true, detail: '打卡旅行家' },
  { title: '一起去鼋头渚', done: true, detail: '吃素面' },
  { title: '一起爬惠山', done: true, detail: '小小爱心线💗，轻松拿捏~' },
  { title: '一起逛惠山古镇', done: true, detail: '端午节去的，人从众' },
  { title: '一起徒步军嶂古道小环线', done: true, detail: '李子线，摘了好多李子~' },
  { title: '一起玩123木头人游戏', done: false, detail: '能拿奖吗？靠敏了~' },
  ...
  { title: '手牵手走遍每个城市', done: false, detail: '用脚步丈量这个世界' }
]
